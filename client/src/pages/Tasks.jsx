              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div
                      onClick={() => toggleStatus(task)}
                      className={`w-7 h-7 mt-1 rounded-full border-2 flex items-center justify-center transition ${
                        expired
                          ? "border-gray-300 cursor-not-allowed"
                          : task.status === "completed"
                          ? "bg-green-400 border-green-400 cursor-pointer"
                    ...
                    <div className="flex-1">
                      ...
                      {/* Priority */}
                      <p
                        className={`mt-1 text-sm font-semibold ${priorityColors[task.priority]}`}
                      >
